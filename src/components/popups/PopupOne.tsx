...
export default function PopupOne({ show }: any) {
        ...
        <Dialog as="div" className="relative z-10" onClose={closeModal}>
          ...
          <div className="fixed inset-0 ">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform h-full rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
